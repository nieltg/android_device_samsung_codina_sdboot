...
CODINARAMFS_KERNEL_U_PATH := $(realpath $(CODINARAMFS_OUT))
...
$(CODINARAMFS_KERNEL_OUT):
	mkdir -p $(CODINARAMFS_KERNEL_OUT)

# Make config & headers install.

$(CODINARAMFS_KERNEL_C): $(CODINARAMFS_KERNEL_OUT) $(CODINARAMFS_OUT)
...
TARGET_CODINARAMFS_KERNEL_M_MAIN: $(CODINARAMFS_KERNEL_OUT) $(CODINARAMFS_KERNEL_C) $(CODINARAMFS_KERNEL_H)
	...
	-$(MAKE) $(MAKE_FLAGS) -C $(CODINARAMFS_KERNEL_S) O=$(CODINARAMFS_KERNEL_OUT) INSTALL_MOD_PATH=$(CODINARAMFS_KERNEL_M_PATH) ARCH=$(TARGET_ARCH) $(ARM_CROSS_COMPILE) modules_install
...
$(TARGET_PREBUILT_INT_KERNEL): $(CODINARAMFS_KERNEL_OUT) $(CODINARAMFS_KERNEL_C) $(CODINARAMFS_KERNEL_M) $(CODINARAMFS_KERNEL_U)
